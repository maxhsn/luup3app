      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-5">
        <div className="md:col-span-6 bento-card p-8 md:p-12 min-h-[280px] md:min-h-[360px] flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="mt-4 md:mt-0">
            ...
            <p className="text-sm md:text-base text-muted-foreground mt-3 md:mt-4 max-w-[400px]">A 7-step flywheel driving compounding advocacy and network growth. This is the core engine LUUP should build around.</p>
          </div>
        </div>
