...
const PrototypeSection = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px_1fr] gap-6 md:gap-10 items-start">
        ...
        <div className="hidden lg:flex flex-col gap-3 pt-12">
          <FeatureCallout
            ...
            title="Home Feed"
            desc="Personalised feed with earnings, missions, brands, and AI assistant."
            active={screen === "home"}
          ...
          <FeatureCallout
            ...
            desc="Gamified tasks with streaks, daily rewards, and progress tracking."
          ...
          <FeatureCallout
            ...
            desc="Points, tiers, cashback, redemptions, and transaction history."
          ...
          <FeatureCallout
            ...
            title="Leaderboard"
            desc="Community rankings with podium, rivalry badges, and challenges."
          ...
          <FeatureCallout
            ...
            title="Social Wall"
            desc="UGC feed with product tags, likes, comments, and sharing."
        ...
        <div className="flex justify-center">
          <div className="wireframe-shell w-[340px] md:w-[380px] overflow-hidden relative">
            ...
            <div className="min-h-[620px] max-h-[620px] overflow-y-auto no-scrollbar">
              ...
              {screen === "wallet" && <WalletScreen onNavigate={navigate} onBack={goBack} />}
              {screen === "leaderboard" && <LeaderboardScreen onBack={goBack} />}
        ...
        <div className="hidden lg:flex flex-col gap-3 pt-12">
          ...
          <FeatureCallout
            ...
            title="Brand Pages"
            desc="Brand hubs with products, missions, social wall, and community."
            active={screen === "brand"}
          ...
          <FeatureCallout
            ...
            title="Profile & Ambassador"
            desc="Stats, referral tools, earnings, and ambassador tier progression."
      ...
      {/* Screen coverage stats */}
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          { label: "Screens", value: "14", desc: "navigable views" },
...
const FeatureCallout = ({ icon, title, desc, active, onClick, interactions }: {
  ...
  <button
    onClick={onClick}
    className={`bento-card p-4 text-left transition-all ${active ? "ring-2 ring-primary shadow-lg" : ""}`}
  >
